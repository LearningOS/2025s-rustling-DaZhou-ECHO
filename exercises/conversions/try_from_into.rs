...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        ...
        // Ok(Self{red:tuple.0.into(),green:tuple.1.into(),blue:tuple.2.into()})
    }
}
...
impl TryFrom<[i16; 3]> for Color {
    ...
    fn try_from(arr: [i16; 3]) -> Result<Self, Self::Error> {
        ...
        for i in arr{
            if i < 0 {return Err(IntoColorError::IntConversion);}
            if i > 255{return Err(IntoColorError::IntConversion)}
        }
...
impl TryFrom<&[i16]> for Color {
    ...
    fn try_from(slice: &[i16]) -> Result<Self, Self::Error> {
        ...
        return Ok(Self{red:slice[0] as u8,green:slice[1] as u8,blue:slice[2] as u8})
    }
}
